...
# adding other PMO fields 
pmotools-runner.py extract_allele_table --file moz2018_PMO.json.gz --bioid Mozambique2018-SeekDeep --output STDOUT --specimen_info_meta_fields collection_country,parasite_density 2>/dev/null | head  
...
# adding other PMO fields including seq field 
pmotools-runner.py extract_allele_table --file moz2018_PMO.json.gz --bioid Mozambique2018-SeekDeep --output STDOUT --specimen_info_meta_fields collection_country,parasite_density --representative_haps_fields seq 2>/dev/null | head 
