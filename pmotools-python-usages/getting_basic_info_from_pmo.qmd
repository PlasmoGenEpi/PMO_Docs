...
```{bash}
pmotools-python list_tar_amp_bioinformatics_info_ids -h 
```
...
#| code-fold: true
#| code-line-numbers: true
#| filename: pmotools-python/src/pmotools/scripts/extract_info_from_pmo/list_tar_amp_bioinformatics_info_ids.py
#| file: ../pmotools-python/src/pmotools/scripts/extract_info_from_pmo/list_tar_amp_bioinformatics_info_ids.py
```
...
```{bash}
cd example 
pmotools-python list_tar_amp_bioinformatics_info_ids --file ../../format/moz2018_PMO.json.gz  

```

```{bash}
cd example 
pmotools-python list_tar_amp_bioinformatics_info_ids --file ../../format/PathWeaverHeome1_PMO.json.gz 
...
pmotools-python list_tar_amp_bioinformatics_info_ids --file combined_Heome1_PMO.json.gz 
...
```{bash}
pmotools-python count_targets_per_sample -h 
```
...
#| code-fold: true
#| code-line-numbers: true
#| filename: pmotools-python/src/pmotools/scripts/extract_info_from_pmo/count_targets_per_sample.py
#| file: ../pmotools-python/src/pmotools/scripts/extract_info_from_pmo/count_targets_per_sample.py
```

```{bash}
cd example 

pmotools-python count_targets_per_sample --file ../../format/moz2018_PMO.json.gz  | head
...
pmotools-python count_targets_per_sample --read_count_minimum 3000 --file ../../format/moz2018_PMO.json.gz  | head
